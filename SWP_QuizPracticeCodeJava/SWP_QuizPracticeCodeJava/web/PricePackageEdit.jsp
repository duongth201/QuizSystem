...
<html lang="zxx">
    <head>
        ...
        <link href="/SWP_QuizPracticeCodeJava/css/subjectStyle.css" rel="stylesheet">
                                        ...
                                        <div class="arion">
                                            <nav class="transparent">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item active" aria-current="page">Edit Price Package</li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="dashboard_wrap">
                                        ...
                                        <div class="form_blocs_wrap">
                                            <form id="formSubmit" action="UpdatePricePackage" method="post">
                                                <div class="row">
                                                    <div> 
                                                            ...
                                                            <div class="tab-content" id="v-pills-tabContent">
                                                                ...
                                                                <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group smalls">
                                                                                ...
                                                                                <input type="text" class="form-control" name="subjectId" value="${subjectId}" readonly="readonly">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group smalls">
                                                                                <label>Package ID</label>
                                                                                <input type="text" class="form-control" name="packageId" value="${pricePackage.packageId}" readonly="readonly">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group smalls">
                                                                        ...
                                                                        <input type="text" class="form-control" name="packageName" value="${pricePackage.packageName}">
                                                                    </div>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group smalls">
                                                                                ...
                                                                                <div class="simple-input">
                                                                                    <select id="cates" class="form-control" name="duration">
                                                                                        <c:forEach begin="1" end="12" var="item">
                                                                                            <option value="${item}" ${item == pricePackage.duration ? "selected":""}>${item}</option>
                                                                                        </c:forEach>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group smalls">
                                                                                ...
                                                                                <div class="simple-input">
                                                                                    <select id="cates" class="form-control" name="status">
                                                                                        <option value="false" ${pricePackage.status == false ? "selected":""}>Deactivated</option>
                                                                                        <option value="true" ${pricePackage.status == true ? "selected":""}>Activated</option>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group smalls">
                                                                                ...
                                                                                <input type="text" class="form-control" name="listPrice" value="${pricePackage.listPrice}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group smalls">
                                                                                <label>Sale Price ($)</label>
                                                                                <input type="text" class="form-control" name="salePrice" value="${pricePackage.salePrice}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group smalls">
