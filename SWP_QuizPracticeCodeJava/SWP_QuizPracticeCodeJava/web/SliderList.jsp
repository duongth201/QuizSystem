                                        ...
                                        <div class="arion">
                                            <nav class="transparent">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item active" aria-current="page">List of slider</li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="dashboard_wrap">
                                        <form action="sliderlist" method="post" style="height:100px">
                                                            ...
                                                            <table class="table-striped table" id="datatablesSimple" width="100%" cellspacing="0">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th>#</th>
                                                                        <th>Slider Title</th>
                                                                        <th>Subject Name<br>(backlink)</th>
                                                                        <th>Image</th>
                                                                        <th>Note</th>
                                                                        <th>Status</th>
                                                                        <th>Action</th>
                                                                ...
                                                                <tbody>
                                                                    <c:forEach items="${listslider}" var="l">
                                                                        <tr>
                                                                            ...
                                                                            <td>${l.sliderTitle}</td>
                                                                            <td>${l.subjectName}</td>
                                                                            <td><img class="" src="/SWP_QuizPracticeCodeJava/img/slider/${l.image}" alt="image" style="width: 360px;height: 200px;"></td>
                                                                            <td><div class="dhs_tags">${l.note}</div></td>
                                                                            ...
                                                                            <td>
                                                                                <div class="dropdown show">
                                                                                    ...
                                                                                    <div class="drp-select dropdown-menu">
                                                                                        <a class="dropdown-item" href="${pageContext.request.contextPath}/marketing/sliderdetail?id=${l.sliderId}">Edit</a>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <!--                                                                            <td>
