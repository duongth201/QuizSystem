                                    ...
                                    <ul id="side-menu">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="nav nav-second-level">
                                                ...
                                                <li><a href="dimensionnew">Add New Dimension</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                        ...
                                        <div class="arion">
                                            <nav class="transparent">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item active" aria-current="page">Update Dimension</li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="dashboard_wrap">
                                        ...
                                        <div class="form_blocs_wrap">
                                            <form id="update" action="dimensionupdate" method="post">
                                                <div class="row justify-content-between">
                                                    ...
                                                    <div class="col-xl-3 col-lg-4 col-md-5 col-sm-12">
                                                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                            ...
                                                            <input type="submit" class="nav-link" id="sweet" value="Finish">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="tab-content" id="v-pills-tabContent">
                                                            ...
                                                            <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                                                                ...
                                                                <div class="form-group smalls">
                                                                    ...
                                                                    <input name="name" type="text" class="form-control" value="${listDimension.getDimensionName()}" required>
                                                                </div>

                                                                <div class="form-group smalls">
                                                                    <label>Description</label>
                                                                    <textarea name="descrip" class="summernote" required>${listDimension.description}</textarea>
                                                                </div>
                                                                    ...
                                                                    <div class="simple-input">
                                                                        <select name="type" class="form-control">
                                                                            <c:forEach items="${listType}" var="type">
                                                                                <option value="${type.typeId}" ${type.typeId==requestScope.listDimension.typeId?"selected":""}>${type.typeName}</option>
                                                                            </c:forEach>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="simple-input">
                                                                        <select name="subject" class="form-control">
                                                                            <c:forEach items="${listSubject}" var="subject">
                                                                                <option value="${subject.subjectId}" ${subject.subjectId==requestScope.listDimension.subjectId?"selected":""}>${subject.subjectName}</option>
                                                                            </c:forEach>
                                                                        </select>
                                                                    </div>
                                                                </div>
