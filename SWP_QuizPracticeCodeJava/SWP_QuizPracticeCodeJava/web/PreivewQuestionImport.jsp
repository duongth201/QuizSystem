                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="breadcrumbs-wrap">
                                <h1 class="breadcrumb-title">Import Question</h1>
                                <nav class="transparent">
                                    <ol class="breadcrumb p-0 bg-white">
                                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                                        <li class="breadcrumb-item active theme-cl" aria-current="page">Import Question</li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <div class="row" style="    margin-bottom: 30px;">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                &nbsp; &nbsp; &nbsp;
                                <form action="ImportQuestionConfirm" method="post">
