                ...
                <div class="container">
                    <div class="row">
                                        ...
                                        <div class="row quiz_body">
                                            ...
                                            <div style="min-height: 180px;" class="question_content">
                                                ...
                                                <img style="height: 200px;
                                                     width: 500px;
                                                     object-fit: cover;" src="${pageContext.request.contextPath}/upload/${ques.image}">
                                            </div>
                                            ...
                                            <div class="question_content question_peeker d-flex mb-3 position-relative">
                                                <body>
                                                    ...
                                                    <div data-toggle="modal" data-target="#exampleModalCenterPeak" class="peak btn btn-primary" style="margin-right: 10px;">View explanation</div>
                        ...
                        <div class="col-lg-2 col-md-12 order-lg-last quesbox" style="">
                            ...
                            <div class="row">
                                <span style="font-weight: bold; color: blue;">Total score: </span>  <span style="color: green; font-weight: bold;">   ${quizReview.point}/100</span>
                            </div>
                            <div class="row">
                                <p style="font-weight: bold; color: blue;">Quiz Result: 
                                    <c:choose>
                                        <c:when test="${quizReview.point > 80}">
                            ...
                            <!--                            <div class="row">
                                                            <button style="color: white;" onclick="submitForm(this)" class="btn btn-danger">NEXT<i class="ti-angle-right"></i></button>
                                                        </div>
                                                         <div class="row">
                                                            <button style="color: white;" onclick="submitForm(this)" class="btn btn-danger">NEXT<i class="ti-angle-right"></i></button>
                                                        </div>-->
