    ...
    <body>
        ...
        <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
            ...
            <c:forEach var="i" begin="0" end="${listSlider.size()-1}">
                ...
                <c:choose>
                    <c:when test="${i == 0}">
                        ...
                        <div class="hero_banner image-cover image_bottom currImg" style="background:#f7f8f9"> <div class="sliderTitle" style="color: black;
                                                                                                                   position: absolute;
                                                                                                                   bottom: 72px;
                                                                                                                   font-size: 38px;
                                                                                                                   font-weight: bold;">${listSlider.get(i).sliderTitle}</div></div>

                    </c:when>
                    <c:otherwise>
                        <div hidden="" class="hero_banner image-cover image_bottom sliderImg" style="background:#f7f8f9 url(${pageContext.request.contextPath}/img/slider/${listSlider.get(i).image}) no-repeat;">${listSlider.get(i).sliderTitle}</div>
            ...
            <i style="position: absolute;
               font-size: 67px;
               color: #ffffff;
               transform: translate(9px, -350px);
               cursor: pointer;" class="fa fa-angle-left prev" aria-hidden="true"></i>
            <i style="    position: absolute;
               font-size: 67px;
               color: #ffffff;
               transform: translate(-9px, -350px);
               right: 0px; cursor: pointer;" class="fa fa-angle-right next" aria-hidden="true"></i>
            <!-- ============================ Hero Banner End ================================== -->
            ...
            <script>
                ...
                var imgArr = document.querySelectorAll('.sliderImg');
                var currImg = document.querySelector('.currImg');
                var url = "url(${pageContext.request.contextPath}/img/slider/${listSlider.get(0).image})";
                currImg.style.backgroundImage = url
                next.onclick = function () {
                    currentIndex++;
                    currImg.style.backgroundImage = imgArr[currentIndex].style.backgroundImage;
                    document.querySelector(".sliderTitle").innerHTML = imgArr[currentIndex].innerHTML;
                };
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7 col-md-8 mt-2">
                            <div class="text-center"><a href="${pageContext.request.contextPath}/PublicSubjectList?order=ASC&page=1&category=&search=&from=&to=" class="btn btn-md theme-bg-light theme-cl">Explore More Cources</a></div>
                        </div>
                    </div>
