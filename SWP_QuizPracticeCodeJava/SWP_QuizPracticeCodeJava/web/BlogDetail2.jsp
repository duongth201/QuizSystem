                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="article_detail_wrapss single_article_wrap format-standard">
                                <div class="article_body_wrap">
                                    ...
                                    <div class="article_featured_image">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/img/blog/${blog.getThumbnail()}"  style="width: 100%">
                                    </div>
                            ...
                            <div class="article_detail_wrapss single_article_wrap format-standard">
                                ...
                                <div class="article_posts_thumb">
                                    <span class="img">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/img/logo/${author.getProfilePic()}">
                                    </span>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="single_widgets widget_category">
                                ...
                                <ul class="sidebar-link">
                                    <c:forEach items="${requestScope.cate}" var="cate">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/postCate?cateid=${cate.getBlogCateId()}">${cate.getCateName()}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
                            ...
                            <div class="single_widgets widget_thumb_post">
                                ...
                                <ul>
                                    <c:forEach items="${requestScope.listBlog}" var="blog" begin="0" end="3">
                                        <li>
<!--                                            <span class="left">
