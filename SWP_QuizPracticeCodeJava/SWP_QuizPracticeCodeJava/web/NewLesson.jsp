                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="dashboard_wrap">
                                        ...
                                        <div class="form_blocs_wrap">
                                            <form id="formSubmit" action="createLesson" method="post">
                                                <div class="row justify-content-between">
                                                    <div class="col-xl-9 col-lg-8 col-md-7 col-sm-12">
                                                        ...
                                                        <div class="tab-content" id="v-pills-tabContent">
                                                            ...
                                                            <div class="tab-pane fade show active" id="v-pills-basic" role="tabpanel" aria-labelledby="v-pills-basic-tab">
                                                                    ...
                                                                    <div class="simple-input">
                                                                        <select id="cates" class="form-control" name="lessonType">
                                                                            ...
                                                                            <c:forEach items="${listType}" var="t">
                                                                                <option value="${t.lessonTypeId}">${t.lessonTypeName}</option>
                                                                            </c:forEach>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group smalls">
                                                                    <label>Content</label>
                                                                    <textarea class="summernote" name="lessonContent"></textarea>
                                                                </div>

                                                                <div class="form-group smalls">
                                                                    <label>Lesson Order</label>
                                                                    <input type="text" class="form-control" name="lessonOrder"
