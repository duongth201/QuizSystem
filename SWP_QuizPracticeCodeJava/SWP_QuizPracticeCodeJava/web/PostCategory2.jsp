                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7 col-md-8">
                            <div class="sec-heading center">
                                <h2><span class="theme-cl">${blogCateName} Articles</span></h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                <div class="blg_grid_box">
                                    <div class="blg_grid_thumb">
                                        <a href="blogDetail?blogid=${l.getBlogId()}"><img src="${pageContext.request.contextPath}/img/blog/${l.getThumbnail()}" class="img-fluid" alt="" /></a>
                                    </div>
