                                        ...
                                        <div class="arion">
                                            <nav class="transparent">
                                                <ol class="breadcrumb">
                                                    ...
                                                    <li class="breadcrumb-item active" aria-current="page">Add New Price Package</li>
                                                </ol>
                                            </nav>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12">
                                    <div class="dashboard_wrap">
                                        ...
                                        <div class="form_blocs_wrap">
                                            <form id="formSubmit" action="CreatePricePackage" method="post">
                                                <div class="row">
                                                    <div> 
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group smalls">
                                                                                ...
                                                                                <input type="text" class="form-control" name="listPrice" placeholder="Enter list price">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group smalls">
                                                                                <label>Sale Price ($)</label>
                                                                                <input type="text" class="form-control" name="salePrice" placeholder="Enter sale price">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group smalls">
