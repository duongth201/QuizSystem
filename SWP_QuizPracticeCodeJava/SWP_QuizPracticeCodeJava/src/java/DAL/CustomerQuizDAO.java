...
public class CustomerQuizDAO extends DBContext {
    ...
    public ArrayList<Subject> getAllNameSubject2(int userid) {
        ArrayList<Subject> list = new ArrayList<>();
        try {
            String sql = "SELECT * FROM dbo.Registration AS r JOIN dbo.Subject AS s ON s.subjectId = r.subjectId WHERE r.userId = ? AND r.isAccepted = 1";
            PreparedStatement statement = connection.prepareStatement(sql);
            statement.setInt(1, userid);
            ResultSet rs = statement.executeQuery();
    ...
    public static void main(String[] args) {
        CustomerQuizDAO c = new CustomerQuizDAO();
//        ArrayList<CustomerQuiz> list = c.searchQuizBySubjectName(1, "", 1, 20);
////        System.out.println(c.countSearchQuizBySubjectName(1, "c"));
//        for (CustomerQuiz p : list) {
//            System.out.println(p);
//        }
        System.out.println(c.getAllQuiz());
