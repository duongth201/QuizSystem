...
public class CreateSubjectController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.insertSubject(subjectName, description, imgURL, featured, status);
        int subjectId = dao.getLatestInsertedSubject();
        dao.insertSubjectCategory(subjectId, catId);
        dao.insertSubjectExpert(subjectId, ownerId);
