 ...
 * @author ADMIN
 */
@WebServlet(name = "SliderListController", urlPatterns = {"/marketing/sliderlist"})
...
//        }
        ...
        if(status.equals("2")){
            listslider = sliderdao.getAllSlider();
        }else{
            listslider = sliderdao.getAllSliderByStatus(status);
        }
