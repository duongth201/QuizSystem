...
public class ImportQuestion extends HttpServlet {
    ...
    public ArrayList<Question> Import(String filename) {
...
//                    qd.insertImportedQuestion(q);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (iter.hasNext()) {
                ...
                if (item.isFormField()) {
                    ...
                    if (filename == null || filename.equals("")) {
                        ...
                        finalPath = storePath + "/" + path.getFileName();
            ...
            ques = Import(finalPath);
            request.setAttribute("path", finalPath);
            request.setAttribute("ques", ques);
            request.getRequestDispatcher("PreivewQuestionImport.jsp").forward(request, response);
